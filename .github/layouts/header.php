...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a href="#">Menu</a>
                <ul>
                    <li><a href="/web_bandoan/pages/monan.php">Món ăn</a></li>
                    <li><a href="/web_bandoan/pages/monnuoc.php">Món nước</a></li>
                    <li><a href="/web_bandoan/pages/combo.php">Combo</a></li>
                    <li><a href="/web_bandoan/pages/trangmieng.php">Tráng miệng</a></li>
                </ul>
            </li>
            <li><a href="/web_bandoan/pages/giohang.php">🛒 Giỏ hàng</a></li>
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-content">
            <li><a href="/web_bandoan/dangxuat.php">Đăng xuất</a></li>
            <li><a href="/web_bandoan/pages/donhang_cuatoi.php">đơn hàng của bạn</a>
